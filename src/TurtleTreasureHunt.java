...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if(tortoiseLocationX == 140 && tortoiseLocationY == 290){
			JOptionPane.showMessageDialog(null, "This is my turf =");
			JOptionPane.showConfirmDialog(null, "go find dory");
		}
		// 7. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		if(tortoiseLocationX == 560 && tortoiseLocationY == 115 || tortoiseLocationX == 50 && tortoiseLocationY == 195){
			Tortoise.explode();
		}
		if(tortoiseLocationX == 325 +- 20 && tortoiseLocationY == 410 +-20){
